...
public class StickMan extends MovingObject implements Controllable {
    ...
    public void die() {
        this.active = false;
        if (this.level.looseALife()) {
            if (this.level != null) {
                this.level.reset(this.level.getScore(),this.level.getLives());
            }
        }else {
            level.lose();
        }
    ...
    public void addScore(int addScore) {
        this.level.setScore(level.getScore() + addScore);
        this.level.setLevelScore(level.getLevelScore()+addScore);
    }

    @Override
    public StickMan clone() {
        StickMan cloneHero=new StickMan(this.xPos,this.yPos+height,this.stringSzie,this.level);
        cloneHero.upgraded=this.upgraded;
        return cloneHero;
    }
